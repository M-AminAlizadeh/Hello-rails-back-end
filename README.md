...
**Hello-rails-backend** is a simple project about showing ranodm greetings using ROR API and React UI

> **Front-end repo [link](https://github.com/M-AminAlizadeh/Hello-react-front-end)**
...
- **Showing different greetings in different languages**
...
```sh
  cd my-folder
  git clone https://github.com/M-AminAlizadeh/Hello-rails-back-end
```
...
Feel free to check the [issues page](https://github.com/M-AminAlizadeh/Hello-rails-back-end/issues).
